...
- Antícipate a las necesidades, actúa con iniciativa propia y mantén un estilo analítico, perspicaz y sin rodeos innecesarios."""

@app.route("/")
def home():
    return "¡Jarvis Agent Core online y operativo con CORS activo!"
